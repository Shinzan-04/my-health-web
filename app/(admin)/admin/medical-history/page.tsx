    ...
    <div className="space-y-6 p-6">
      ...
      {loading ? (
        ...
        <div className="overflow-x-auto border border-gray-300 rounded-xl shadow-sm bg-white">
          <table className="min-w-[1200px] w-full text-sm border border-gray-300 rounded-xl">
            <thead className="bg-gray-100 border-b border-gray-300">
              <tr>
                <th className="border border-gray-300 px-4 py-3 text-gray-700 uppercase font-semibold tracking-wide">
                  ID
                </th>
                <th className="border border-gray-300 px-4 py-3 text-gray-700 uppercase font-semibold tracking-wide">
                  Bệnh nhân
            ...
            <tbody>
              {filteredData.length === 0 ? (
                <tr>
                  <td
                    colSpan={9}
                    className="text-center py-6 text-gray-400 border border-gray-300"
                  >
                    Không có dữ liệu.
                  </td>
                </tr>
                ...
                filteredData.map((item, index) => (
                  ...
                  >
                    ...
                    <td className="border border-gray-300 px-4 py-2 text-gray-500 whitespace-pre-wrap">
                      {item.prescription}
                    </td>
                    <td className="border border-gray-300 px-4 py-2 text-gray-500 whitespace-pre-wrap">
                      {item.notes}
